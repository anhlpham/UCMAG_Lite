 function farm = mag0_setup_farm(param,farm)
%----------------------------------------------------------------------
...
%----------------------------------------------------------------------
 ...
 case 2
    ...
    error(['[mag0_setup_farm.m] grid_mode not defined']);
 case 3
    % Add new case here and remove following line
    error(['[mag0_setup_farm.m] grid_mode not defined']);
 otherwise
 ...
 if isempty(tmp)
    error('[mag0_setup_farm.m] WARNING: Could not find canopy start; set as the surface layer');
